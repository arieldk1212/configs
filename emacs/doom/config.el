...
(setq doom-font (font-spec :family "Menlo" :size 13 :weight 'regular))
...
(map! :i "C-z" #'undo)
;; Multi-cursor with Cmd + Option + Arrows
(map! :nv "s-M-<down>" #'evil-mc-make-cursor-move-next-line)
(map! :nv "s-M-<up>"   #'evil-mc-make-cursor-move-prev-line)
;; Map Command + F2 to "Change All Occurrences" (iedit)
(map! :nvie "s-<f2>" #'iedit-mode)
